...
void main() {
  ...
  animatedPosition.x = (radius + offsetX) * cos(angle + uTime * random(position, uTime) * 0.1);
  animatedPosition.y = (radius + offsetY) * sin(angle + uTime * random(position, uTime) * 0.1);
